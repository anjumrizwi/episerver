...
namespace EPiServerDemoSite.Controllers
{
    ...
    public class DefaultPageController : PageControllerBase<EPiPageData>
    {
        
        public ViewResult Index(EPiPageData currentPage)
        {
        ...
        /// </remarks>
        private static IPageViewModel<EPiPageData> CreateModel(EPiPageData page)
        {
            var type = typeof(PageViewModel<>).MakeGenericType(page.GetOriginalType());
            return Activator.CreateInstance(type, page) as IPageViewModel<EPiPageData>;
        }
    }
}
